...
function OrderForm() {
  ...
  return (
    <form onSubmit={handleSubmit(generateOrder)}>
      ...
      />
      {errors.name?.type === "required" && <p className="alert alert-danger">Nombre requerido</p>}
      ...
      />
      {errors.phoneNumber?.type === "required" && <p className="alert alert-danger">Teléfono requerido</p>}
      {errors.phoneNumber?.type === "minLength" && <p className="alert alert-danger">Mínimo 9 números</p>}
      ...
      />
      {errors.email?.type === "required" && <p className="alert alert-danger">Email requerido</p>}
      {errors.email?.type === "pattern" && <p className="alert alert-danger">Formato email incorrecto</p>}
      ...
      />
      {errors.reEmail?.type === "required" && <p className="alert alert-danger">Email requerido</p>}
      {errors.reEmail?.type === "validate" && <p className="alert alert-danger">Los emails no coinciden</p>}

      <Button className="principalBtn w-50" type="submit">
        GENERATE ORDER
      </Button>
    </form>
  );
